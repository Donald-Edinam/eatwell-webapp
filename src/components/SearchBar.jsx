        ...
        <>
            ...
            <form className="flex items-center max-w-sm mt-10 mx-auto py-5 px-4">
                ...
                <div className="relative w-full">
                    ...
                    <input type="text" id="simple-search" className="bg-white border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" placeholder="Search branch name..." required />
                </div>
